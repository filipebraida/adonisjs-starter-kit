...
const routes = {
  ...
  'auth.reset_password.show': {
    ...
    tokens: [
      { old: '/reset-password/:token', type: 0, val: 'reset-password', end: '' },
      { old: '/reset-password/:token', type: 1, val: 'token', end: '' },
    ],
  ...
  'social.create': {
    ...
    tokens: [
      { old: '/:provider/redirect', type: 1, val: 'provider', end: '' },
      { old: '/:provider/redirect', type: 0, val: 'redirect', end: '' },
    ],
  ...
  'social.callback': {
    ...
    tokens: [
      { old: '/:provider/callback', type: 1, val: 'provider', end: '' },
      { old: '/:provider/callback', type: 0, val: 'callback', end: '' },
    ],
  ...
  'locale.switch': {
    ...
    tokens: [
      { old: '/switch/:locale', type: 0, val: 'switch', end: '' },
      { old: '/switch/:locale', type: 1, val: 'locale', end: '' },
    ],
  ...
  'users.invite.show': {
    ...
    tokens: [
      { old: '/users/invite', type: 0, val: 'users', end: '' },
      { old: '/users/invite', type: 0, val: 'invite', end: '' },
    ],
  ...
  'users.impersonate.handle': {
    ...
    tokens: [
      { old: '/users/impersonate/:id', type: 0, val: 'users', end: '' },
      { old: '/users/impersonate/:id', type: 0, val: 'impersonate', end: '' },
      { old: '/users/impersonate/:id', type: 1, val: 'id', end: '' },
    ],
  ...
  'users.create': {
    ...
    tokens: [
      { old: '/users/create', type: 0, val: 'users', end: '' },
      { old: '/users/create', type: 0, val: 'create', end: '' },
    ],
  ...
  'users.edit': {
    ...
    tokens: [
      { old: '/users/:id/edit', type: 0, val: 'users', end: '' },
      { old: '/users/:id/edit', type: 1, val: 'id', end: '' },
      { old: '/users/:id/edit', type: 0, val: 'edit', end: '' },
    ],
  ...
  'profile.update': {
    ...
    tokens: [
      { old: '/settings/profile', type: 0, val: 'settings', end: '' },
      { old: '/settings/profile', type: 0, val: 'profile', end: '' },
    ],
  ...
  'password.update': {
    ...
    tokens: [
      { old: '/settings/password', type: 0, val: 'settings', end: '' },
      { old: '/settings/password', type: 0, val: 'password', end: '' },
    ],
  ...
  'tokens.destroy': {
    ...
    tokens: [
      { old: '/settings/tokens/:id', type: 0, val: 'settings', end: '' },
      { old: '/settings/tokens/:id', type: 0, val: 'tokens', end: '' },
      { old: '/settings/tokens/:id', type: 1, val: 'id', end: '' },
    ],
  ...
  'tokens.store': {
    ...
    tokens: [
      { old: '/settings/tokens', type: 0, val: 'settings', end: '' },
      { old: '/settings/tokens', type: 0, val: 'tokens', end: '' },
    ],
